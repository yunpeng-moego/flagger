...
type destinationRules struct {
	*gentype.ClientWithList[*v1alpha3.DestinationRule, *v1alpha3.DestinationRuleList]
}
...
func newDestinationRules(c *NetworkingV1alpha3Client, namespace string) *destinationRules {
	return &destinationRules{
		gentype.NewClientWithList[*v1alpha3.DestinationRule, *v1alpha3.DestinationRuleList](
			"destinationrules",
			c.RESTClient(),
			scheme.ParameterCodec,
			namespace,
			func() *v1alpha3.DestinationRule { return &v1alpha3.DestinationRule{} },
			func() *v1alpha3.DestinationRuleList { return &v1alpha3.DestinationRuleList{} }),
	}
}
