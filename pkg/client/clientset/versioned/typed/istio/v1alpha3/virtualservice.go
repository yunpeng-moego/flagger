...
type virtualServices struct {
	*gentype.ClientWithList[*v1alpha3.VirtualService, *v1alpha3.VirtualServiceList]
}
...
func newVirtualServices(c *NetworkingV1alpha3Client, namespace string) *virtualServices {
	return &virtualServices{
		gentype.NewClientWithList[*v1alpha3.VirtualService, *v1alpha3.VirtualServiceList](
			"virtualservices",
			c.RESTClient(),
