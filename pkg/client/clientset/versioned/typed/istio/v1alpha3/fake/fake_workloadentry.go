...
func (c *FakeWorkloadEntries) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha3.WorkloadEntry, err error) {
	emptyResult := &v1alpha3.WorkloadEntry{}
	obj, err := c.Fake.
...
func (c *FakeWorkloadEntries) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha3.WorkloadEntryList, err error) {
	emptyResult := &v1alpha3.WorkloadEntryList{}
	obj, err := c.Fake.
...
func (c *FakeWorkloadEntries) UpdateStatus(ctx context.Context, workloadEntry *v1alpha3.WorkloadEntry, opts v1.UpdateOptions) (result *v1alpha3.WorkloadEntry, err error) {
	emptyResult := &v1alpha3.WorkloadEntry{}
	obj, err := c.Fake.
