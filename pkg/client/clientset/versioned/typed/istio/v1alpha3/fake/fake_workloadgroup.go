...
func (c *FakeWorkloadGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha3.WorkloadGroup, err error) {
	emptyResult := &v1alpha3.WorkloadGroup{}
	obj, err := c.Fake.
...
func (c *FakeWorkloadGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha3.WorkloadGroupList, err error) {
	emptyResult := &v1alpha3.WorkloadGroupList{}
	obj, err := c.Fake.
...
func (c *FakeWorkloadGroups) UpdateStatus(ctx context.Context, workloadGroup *v1alpha3.WorkloadGroup, opts v1.UpdateOptions) (result *v1alpha3.WorkloadGroup, err error) {
	emptyResult := &v1alpha3.WorkloadGroup{}
	obj, err := c.Fake.
